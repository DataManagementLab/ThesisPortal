...
test('homepage has title and links to login page', async ({ page }) => {
  ...
  await expect(getStarted).toHaveAttribute('href', 'https://login.tu-darmstadt.de/idp/profile/cas/login?service=http://thesisfinder-local.tu-darmstadt.de.test:5173');
